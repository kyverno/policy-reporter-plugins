...
func NewClient(metaClient metadata.Interface, dynamicClient dynamic.Interface, kclient policiesv1beta1.ImageValidatingPolicyInterface, coreClient *core.Client, cache *gocache.Cache[string, []sdk.PolicyListItem]) Client {
