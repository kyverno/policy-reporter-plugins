...
type CleanupPolicyInformer interface {
	...
	Lister() kyvernov2beta1.CleanupPolicyLister
}
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KyvernoV2beta1().CleanupPolicies(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KyvernoV2beta1().CleanupPolicies(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KyvernoV2beta1().CleanupPolicies(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KyvernoV2beta1().CleanupPolicies(namespace).Watch(ctx, options)
			},
		}, client),
		&apikyvernov2beta1.CleanupPolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *cleanupPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apikyvernov2beta1.CleanupPolicy{}, f.defaultInformer)
}

func (f *cleanupPolicyInformer) Lister() kyvernov2beta1.CleanupPolicyLister {
	return kyvernov2beta1.NewCleanupPolicyLister(f.Informer().GetIndexer())
}
