...
type GlobalContextEntryInformer interface {
	...
	Lister() kyvernov2beta1.GlobalContextEntryLister
}
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KyvernoV2beta1().GlobalContextEntries().List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KyvernoV2beta1().GlobalContextEntries().Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KyvernoV2beta1().GlobalContextEntries().List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KyvernoV2beta1().GlobalContextEntries().Watch(ctx, options)
			},
		}, client),
		&apikyvernov2beta1.GlobalContextEntry{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *globalContextEntryInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apikyvernov2beta1.GlobalContextEntry{}, f.defaultInformer)
}

func (f *globalContextEntryInformer) Lister() kyvernov2beta1.GlobalContextEntryLister {
	return kyvernov2beta1.NewGlobalContextEntryLister(f.Informer().GetIndexer())
}
