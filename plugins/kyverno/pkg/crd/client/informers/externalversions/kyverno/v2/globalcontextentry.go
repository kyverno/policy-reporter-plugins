...
import (
	...
	apikyvernov2 "github.com/kyverno/policy-reporter/kyverno-plugin/pkg/crd/api/kyverno/v2"
	...
	kyvernov2 "github.com/kyverno/policy-reporter/kyverno-plugin/pkg/crd/client/listers/kyverno/v2"
...
type GlobalContextEntryInformer interface {
	...
	Lister() kyvernov2.GlobalContextEntryLister
}
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KyvernoV2().GlobalContextEntries().List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KyvernoV2().GlobalContextEntries().Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KyvernoV2().GlobalContextEntries().List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KyvernoV2().GlobalContextEntries().Watch(ctx, options)
			},
		}, client),
		&apikyvernov2.GlobalContextEntry{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *globalContextEntryInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apikyvernov2.GlobalContextEntry{}, f.defaultInformer)
}

func (f *globalContextEntryInformer) Lister() kyvernov2.GlobalContextEntryLister {
	return kyvernov2.NewGlobalContextEntryLister(f.Informer().GetIndexer())
}
