...
type ImageValidatingPolicyInformer interface {
	...
	Lister() policieskyvernoiov1beta1.ImageValidatingPolicyLister
}
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PoliciesV1beta1().ImageValidatingPolicies().List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PoliciesV1beta1().ImageValidatingPolicies().Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PoliciesV1beta1().ImageValidatingPolicies().List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PoliciesV1beta1().ImageValidatingPolicies().Watch(ctx, options)
			},
		}, client),
		&apipolicieskyvernoiov1beta1.ImageValidatingPolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *imageValidatingPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apipolicieskyvernoiov1beta1.ImageValidatingPolicy{}, f.defaultInformer)
}

func (f *imageValidatingPolicyInformer) Lister() policieskyvernoiov1beta1.ImageValidatingPolicyLister {
	return policieskyvernoiov1beta1.NewImageValidatingPolicyLister(f.Informer().GetIndexer())
}
