...
type ValidatingPolicyInformer interface {
	...
	Lister() policieskyvernoiov1beta1.ValidatingPolicyLister
}
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PoliciesV1beta1().ValidatingPolicies().List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PoliciesV1beta1().ValidatingPolicies().Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PoliciesV1beta1().ValidatingPolicies().List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PoliciesV1beta1().ValidatingPolicies().Watch(ctx, options)
			},
		}, client),
		&apipolicieskyvernoiov1beta1.ValidatingPolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *validatingPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apipolicieskyvernoiov1beta1.ValidatingPolicy{}, f.defaultInformer)
}

func (f *validatingPolicyInformer) Lister() policieskyvernoiov1beta1.ValidatingPolicyLister {
	return policieskyvernoiov1beta1.NewValidatingPolicyLister(f.Informer().GetIndexer())
}
