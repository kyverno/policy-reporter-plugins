...
type MutatingPolicyInformer interface {
	...
	Lister() policieskyvernoiov1beta1.MutatingPolicyLister
}
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PoliciesV1beta1().MutatingPolicies().List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PoliciesV1beta1().MutatingPolicies().Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PoliciesV1beta1().MutatingPolicies().List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PoliciesV1beta1().MutatingPolicies().Watch(ctx, options)
			},
		}, client),
		&apipolicieskyvernoiov1beta1.MutatingPolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *mutatingPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apipolicieskyvernoiov1beta1.MutatingPolicy{}, f.defaultInformer)
}

func (f *mutatingPolicyInformer) Lister() policieskyvernoiov1beta1.MutatingPolicyLister {
	return policieskyvernoiov1beta1.NewMutatingPolicyLister(f.Informer().GetIndexer())
}
