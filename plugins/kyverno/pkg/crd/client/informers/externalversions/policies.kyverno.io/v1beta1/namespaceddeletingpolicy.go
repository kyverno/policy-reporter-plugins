...
type NamespacedDeletingPolicyInformer interface {
	...
	Lister() policieskyvernoiov1beta1.NamespacedDeletingPolicyLister
}
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PoliciesV1beta1().NamespacedDeletingPolicies(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PoliciesV1beta1().NamespacedDeletingPolicies(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PoliciesV1beta1().NamespacedDeletingPolicies(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PoliciesV1beta1().NamespacedDeletingPolicies(namespace).Watch(ctx, options)
			},
		}, client),
		&apipolicieskyvernoiov1beta1.NamespacedDeletingPolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *namespacedDeletingPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apipolicieskyvernoiov1beta1.NamespacedDeletingPolicy{}, f.defaultInformer)
}

func (f *namespacedDeletingPolicyInformer) Lister() policieskyvernoiov1beta1.NamespacedDeletingPolicyLister {
	return policieskyvernoiov1beta1.NewNamespacedDeletingPolicyLister(f.Informer().GetIndexer())
}
