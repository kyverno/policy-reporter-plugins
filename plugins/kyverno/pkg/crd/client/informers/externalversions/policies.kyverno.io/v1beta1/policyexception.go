...
type PolicyExceptionInformer interface {
	...
	Lister() policieskyvernoiov1beta1.PolicyExceptionLister
}
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PoliciesV1beta1().PolicyExceptions(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PoliciesV1beta1().PolicyExceptions(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PoliciesV1beta1().PolicyExceptions(namespace).List(ctx, options)
			},
...
func (f *policyExceptionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apipolicieskyvernoiov1beta1.PolicyException{}, f.defaultInformer)
}

func (f *policyExceptionInformer) Lister() policieskyvernoiov1beta1.PolicyExceptionLister {
	return policieskyvernoiov1beta1.NewPolicyExceptionLister(f.Informer().GetIndexer())
}
