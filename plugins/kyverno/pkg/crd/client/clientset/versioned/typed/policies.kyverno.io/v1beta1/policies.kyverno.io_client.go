...
// NewForConfig creates a new PoliciesV1beta1Client for the given config.
// NewForConfig is equivalent to NewForConfigAndClient(c, httpClient),
// where httpClient was generated with rest.HTTPClientFor(c).
func NewForConfig(c *rest.Config) (*PoliciesV1beta1Client, error) {
	config := *c
...
// NewForConfigAndClient creates a new PoliciesV1beta1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*PoliciesV1beta1Client, error) {
	config := *c
	setConfigDefaults(&config)
	...
	return &PoliciesV1beta1Client{client}, nil
}

// NewForConfigOrDie creates a new PoliciesV1beta1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *PoliciesV1beta1Client {
...
// New creates a new PoliciesV1beta1Client for the given RESTClient.
func New(c rest.Interface) *PoliciesV1beta1Client {
	return &PoliciesV1beta1Client{c}
}

func setConfigDefaults(config *rest.Config) {
	gv := policieskyvernoiov1beta1.SchemeGroupVersion
...
func (c *PoliciesV1beta1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
