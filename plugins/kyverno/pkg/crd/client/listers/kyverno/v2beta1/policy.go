...
type PolicyLister interface {
	...
	List(selector labels.Selector) (ret []*kyvernov2beta1.Policy, err error)
...
type policyLister struct {
	listers.ResourceIndexer[*kyvernov2beta1.Policy]
}

// NewPolicyLister returns a new PolicyLister.
func NewPolicyLister(indexer cache.Indexer) PolicyLister {
	return &policyLister{listers.New[*kyvernov2beta1.Policy](indexer, kyvernov2beta1.Resource("policy"))}
}

// Policies returns an object that can list and get Policies.
func (s *policyLister) Policies(namespace string) PolicyNamespaceLister {
	return policyNamespaceLister{listers.NewNamespaced[*kyvernov2beta1.Policy](s.ResourceIndexer, namespace)}
}
...
type PolicyNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*kyvernov2beta1.Policy, error)
