...
type policyExceptionLister struct {
	listers.ResourceIndexer[*kyvernov2beta1.PolicyException]
}
...
func NewPolicyExceptionLister(indexer cache.Indexer) PolicyExceptionLister {
	return &policyExceptionLister{listers.New[*kyvernov2beta1.PolicyException](indexer, kyvernov2beta1.Resource("policyexception"))}
}

// PolicyExceptions returns an object that can list and get PolicyExceptions.
func (s *policyExceptionLister) PolicyExceptions(namespace string) PolicyExceptionNamespaceLister {
	return policyExceptionNamespaceLister{listers.NewNamespaced[*kyvernov2beta1.PolicyException](s.ResourceIndexer, namespace)}
}
...
type PolicyExceptionNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*kyvernov2beta1.PolicyException, error)
